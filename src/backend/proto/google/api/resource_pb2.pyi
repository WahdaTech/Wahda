...
class ResourceDescriptor(google.protobuf.message.Message):
    ...
    Example:
        ...
        message Topic {
          ...
          option (proto.google.api.resource) = {
...
class ResourceReference(google.protobuf.message.Message):
    ...
    Example:
        ...
        message Subscription {
          string topic = 2 [(proto.google.api.resource_reference) = {
            type: "pubsub.googleapis.com/Topic"
          }];
        }
    ...
    Example:
        ...
        message GetIamPolicyRequest {
          string resource = 2 [(proto.google.api.resource_reference) = {
            type: "*"
          }];
        }
    """
    ...
    Example:
        ...
        message ListLogEntriesRequest {
          string parent = 1 [(proto.google.api.resource_reference) = {
