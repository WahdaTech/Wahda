...
class _FieldBehaviorEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_FieldBehavior.ValueType], builtins.type):
    ...
    *must not* throw an error as a result of the field's presence).
    ...
    proto.google.api.resource) is used in the resource name to uniquely identify the
...
Examples:
  ...
  string name = 1 [(proto.google.api.field_behavior) = REQUIRED];
  State state = 1 [(proto.google.api.field_behavior) = OUTPUT_ONLY];
  google.protobuf.Duration ttl = 1
    [(proto.google.api.field_behavior) = INPUT_ONLY];
  google.protobuf.Timestamp expire_time = 1
    [(proto.google.api.field_behavior) = OUTPUT_ONLY,
     (proto.google.api.field_behavior) = IMMUTABLE];
"""
