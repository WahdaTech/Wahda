...
class _ErrorReasonEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ErrorReason.ValueType], builtins.type):
    ...
    """
    SERVICE_NOT_VISIBLE: _ErrorReason.ValueType  # 29
    """Unimplemented. Do not use.
    ...
    """
    GCP_SUSPENDED: _ErrorReason.ValueType  # 30
    ...
    """
    LOCATION_POLICY_VIOLATED: _ErrorReason.ValueType  # 31
...
"""
SERVICE_NOT_VISIBLE: ErrorReason.ValueType  # 29
"""Unimplemented. Do not use.
...
"projects/123" (or it may not exist).
"""
GCP_SUSPENDED: ErrorReason.ValueType  # 30
"""The request is related to a project for which GCP access is suspended.
...
This response indicates the associated GCP account has been suspended.
"""
LOCATION_POLICY_VIOLATED: ErrorReason.ValueType  # 31
"""The request violates the location policies when creating resources in
the restricted region.
