...
import proto.google.api.launch_stage_pb2
...
class ClientLibrarySettings(google.protobuf.message.Message):
    ...
    """
    launch_stage: proto.google.api.launch_stage_pb2.LaunchStage.ValueType
...
class Publishing(google.protobuf.message.Message):
    ...
    """
    rest_reference_documentation_uri: builtins.str
...
class DotnetSettings(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["common", b"common"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["common", b"common", "forced_namespace_aliases", b"forced_namespace_aliases", "handwritten_signatures", b"handwritten_signatures", "ignored_resources", b"ignored_resources", "renamed_resources", b"renamed_resources", "renamed_services", b"renamed_services"]) -> None: ...
...
class MethodSettings(google.protobuf.message.Message):
    ...
    class LongRunning(google.protobuf.message.Message):
        ...
        generators (e.g.
        [Java](https://github.com/googleapis/gapic-generator-java/blob/04c2faa191a9b5a10b92392fe8482279c4404803/src/main/java/com/proto.google.api/generator/gapic/composer/common/RetrySettingsComposer.java)).
        """
    ...
    def auto_populated_fields(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.str]:
        ...
        (proto.google.api.field_info).format. Currently supported format: UUID4.
    ...
    def ClearField(self, field_name: typing.Literal["auto_populated_fields", b"auto_populated_fields", "long_running", b"long_running", "selector", b"selector"]) -> None: ...
...
For example, the proto RPC and annotation:
  ...
  rpc CreateSubscription(CreateSubscriptionRequest)
    ...
    option (proto.google.api.method_signature) = "name,topic";
  }
...
Example:
  ...
  service Foo {
    option (proto.google.api.default_host) = "foo.googleapi.com";
    ...
  }
"""
...
Example:
  ...
  service Foo {
    option (proto.google.api.oauth_scopes) = \\
...
"""
api_version: google.protobuf.internal.extension_dict._ExtensionFieldDescriptor[google.protobuf.descriptor_pb2.ServiceOptions, builtins.str]
...
Example:
  ...
  service Foo {
    option (proto.google.api.api_version) = "v1_20230821_preview";
  }
"""
