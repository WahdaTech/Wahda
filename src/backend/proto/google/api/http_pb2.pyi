...
class Http(google.protobuf.message.Message):
    ...
    [HttpRule][proto.google.api.HttpRule], each specifying the mapping of an RPC method
...
class HttpRule(google.protobuf.message.Message):
    ...
    typically specified as an `proto.google.api.http` annotation on the gRPC method.
    ...
    1. Leaf request fields (recursive expansion nested messages in the request
       ...
       - Fields referred by the [HttpRule.body][proto.google.api.HttpRule.body]. They
       ...
       - All other fields are passed via the URL query parameters, and the
         ...
         name.
     2. If [HttpRule.body][proto.google.api.HttpRule.body] is "*", there is no URL
     query parameter, all fields
        are passed via URL path and HTTP request body.
     3. If [HttpRule.body][proto.google.api.HttpRule.body] is omitted, there is no HTTP
     request body, all
    ...
    service config is simply the YAML representation of the `proto.google.api.Service`
    proto message.
