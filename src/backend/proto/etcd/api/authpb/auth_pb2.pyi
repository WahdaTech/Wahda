...
class UserAddOptions(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["no_password", b"no_password"]) -> None: ...
...
class User(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["name", b"name", "options", b"options", "password", b"password", "roles", b"roles"]) -> None: ...
...
class Permission(google.protobuf.message.Message):
    ...
    class _TypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Permission._Type.ValueType], builtins.type):
    ...
    def ClearField(self, field_name: typing.Literal["key", b"key", "permType", b"permType", "range_end", b"range_end"]) -> None: ...
...
class Role(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["keyPermission", b"keyPermission", "name", b"name"]) -> None: ...
